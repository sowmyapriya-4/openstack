...
# sudo yum -y install openstack-swift-account openstack-swift-container openstack-swift-object xfsprogs rsync rsync-daemon openssh-clients
...
sudo curl -o /etc/swift/account-server.conf https://opendev.org/openstack/swift/raw/branch/stable/victoria/etc/account-server.conf-sample

sudo curl -o /etc/swift/container-server.conf https://opendev.org/openstack/swift/raw/branch/stable/victoria/etc/container-server.conf-sample

sudo curl -o /etc/swift/object-server.conf https://opendev.org/openstack/swift/raw/branch/stable/rocky/etc/object-server.conf-sample
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set SELinux Context for the Storage Devices
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
sudo firewall-cmd --add-port={873/tcp,6200/tcp,6201/tcp,6202/tcp} --permanent 
